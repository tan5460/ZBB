...
class ServiceRegiestForemanVC: BaseViewController, CompanyTypePickerDelegate, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private var tagTitles = ["做工精细", "超强团队", "服务极好", "价格合理"]
...
extension ServiceRegiestForemanVC: UITableViewDelegate, UITableViewDataSource {
...
// MARK: - 按钮点击方法
extension ServiceRegiestForemanVC {

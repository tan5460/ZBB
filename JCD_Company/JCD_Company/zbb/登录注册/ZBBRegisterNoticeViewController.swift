//
//  ZBBRegisterNoticeViewController.swift
//  JCD_Company
//
//  Created by YJ on 2025/1/10.
//

import UIKit

class ZBBRegisterNoticeViewController: BaseViewController {
    ...
    private func createViews() {
        ...
        msgLabel = UILabel()
        msgLabel.attributedText = NSAttributedString(string: "恭喜您注册成功！", attributes: [.paragraphStyle : style])
        ...
        sureBtn.setTitle("立即进入APP", for: .normal)

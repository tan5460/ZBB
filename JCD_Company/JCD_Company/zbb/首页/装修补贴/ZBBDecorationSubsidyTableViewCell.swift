//
//  ZBBDecorationSubsidyTableViewCell.swift
//  JCD_Company
//
...
class ZBBDecorationSubsidyTableViewCell: UITableViewCell {
    ...
    private func createViews() {
        ...
        applyBtn.layer.borderColor = UIColor.hexColor("#AAACB5").cgColor
        applyBtn.layer.masksToBounds = true
        applyBtn.titleLabel?.font = .systemFont(ofSize: 13)
        applyBtn.setTitle("立即申领", for: .normal)
        applyBtn.setTitleColor(.hexColor("#131313"), for: .normal)

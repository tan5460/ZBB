...
class TDWVerifyCodeNumView: UIView {
    ...
    /// 光标颜色
    var cursorColor = UIColor.k1DC597
...
//    }()
    ...
    override init(frame: CGRect) {
        ...
        borderWidth(0.5).borderColor(UIColor.hexColor("#61D9B9")).cornerRadius(4).masksToBounds()
...
//
    ...
    override func layoutSubviews() {
        ...
        let path = UIBezierPath.init(rect: CGRect.init(x: self.frame.size.width * 0.5, y: self.frame.size.height * 0.25, width: 0.5, height: self.frame.size.height * 0.5))
